    ...
    fetch('http://localhost:8080/equipamentos')
        ...
        .then(equipamentos => {
            ...
            equipamentos.forEach(item => {
                    ...
                    if (
  (filtroFilial === '' || item.localizacao === filtroFilial) &&
  (filtroCategoria === '' || item.categoria === filtroCategoria)
    ...
    const filtroEquipamentos = () => {
        ...
        if (!filtragemEmpresa) {
            ...
            filtroFilial = filtragemEmpresa;
        }
        if(!filtragemCategoria){
            filtroCategoria = filtragemCategoria;
        }
        else{
            filtroCategoria = filtragemCategoria;
        }
    ...
    document.getElementById("btnFiltro").addEventListener("click", filtroEquipamentos);
